...
c.execute('''
CREATE TABLE IF NOT EXISTS doctorappointmentrequests (
    docid TEXT,
    patientname TEXT,
    patientnum BIGINT,
...
@app.route('/docreg')
def docreg():
    return render_template('docterresgitrationlogin.html') 
...
def patientlogin():
    ...
    try:
        ...
        return render_template('login1.html',err='Please enter correct credentials...')
...
def doctorlogin():
    ...
    for i in registerd_doctors:
        ...
        return render_template('login2.html',err='Please enter correct credentials...')
...
def adminlogin():
    ...
    for i in superusercreds:
        ...
        return render_template('login3.html',err='Please enter correct credentials...')
